...
public class OnlineFoodOrderingSystem {
    ...
    public static void showRestaurantMenu() {
        ...
        for (String restaurant : restaurantAddressMap.keySet()) {
            System.out.println("Restoran: " + restaurant);
    ...
    public static void createOrder() {
        ...
        if (selectedIndex >= 1 && selectedIndex <= restaurantFoodMenuMap.size()) {
            ...
            for (String foodItem : foodMenu.keySet()) {
                System.out.println(itemIndex + ". " + foodItem + " - Rp" + foodMenu.get(foodItem));
                itemIndex++;
            }

            System.out.println("Menu Minuman:");
            for (String drinkItem : drinkMenu.keySet()) {
                System.out.println(itemIndex + ". " + drinkItem + " - Rp" + drinkMenu.get(drinkItem));
                itemIndex++;
            }
            ...
            if (selectedMenuIndex >= 1 && selectedMenuIndex <= foodMenu.size() + drinkMenu.size()) {
                ...
                if (selectedMenuIndex <= foodMenu.size()) {
                    selectedItem = foodMenu.keySet().toArray(new String[0])[selectedMenuIndex - 1];
                    price = foodMenu.get(selectedItem);
                } else {
                    selectedItem = drinkMenu.keySet().toArray(new String[0])[selectedMenuIndex - 1 - foodMenu.size()];
                ...
                System.out.println("Pesanan berhasil dibuat: " + selectedItem + " sejumlah " + quantity + " dengan total harga Rp" + total);
